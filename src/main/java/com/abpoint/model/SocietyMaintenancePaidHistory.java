	 ...
	 @Override
	    public boolean equals(Object o) {
	        ...
	        return flatNumber == that.flatNumber &&
	                Double.compare(that.annualMaintenance, annualMaintenance) == 0 &&
	    ...
	    @Override
	    public int hashCode() {
	        return Objects.hash(flatNumber, year, flatType, annualMaintenance, date, paymentMethod, transactionId, amount, verified);
	    }
